...
The file run.sh should be excecuted to generate the embeddings. This file call the generate_embeddings.py file, it is necessary to only call this file using run.sh  since during the execution intermediate files necessary for the correct embeddings generation.
